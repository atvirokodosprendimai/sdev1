...
Seventeen records are **Accepted and implemented**: ADR-001 through ADR-012,
ADR-015, ADR-016, ADR-017, ADR-019 and ADR-020. Two carry one of their two tasks — ADR-009's
