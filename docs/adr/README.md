...
Eight records are **Accepted and implemented**: ADR-001 through ADR-006, ADR-016
and ADR-017. Their `Governs:` paths resolve, their tasks carry tool-written
